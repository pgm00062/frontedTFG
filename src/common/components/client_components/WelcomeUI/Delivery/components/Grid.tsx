...
export default function WelcomeGrid({ full = true, userPreview, projectsPreview, statisticsPreview, invoicesPreview, timePreview, dailyTotalTime }: GridProps) {
  ...
  return (
    <section className="welcome-grid">
      <article className="welcome-card"><h3 style={{ margin: 0, fontWeight: 700 }}>Facturas</h3></article>
      ...
      <article className="welcome-card"><h3 style={{ margin: 0, fontWeight: 700 }}>Tiempo</h3></article>
    </section>
  )
}